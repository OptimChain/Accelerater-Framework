...
# MAGIC  
# MAGIC %md
# MAGIC # Query Zone Processing - Overwrite DIMProduct
...
dbutils.widgets.text(name="tableName", defaultValue="DIMProduct", label="Table Name")
...
filename = fullPathPrefix + "/Landing/ABC Company 2019%20Training - Tax Only(990235)BL"

https://rsmedpovdlhggd.blob.core.windows.net/rsm/Landing/ABC Company 2019 Training - Tax Only(990235)BL.dbf
...
notebookName = "Query Zone Processing - Overwrite DIMProduct"
...
SELECT DISTINCT
  NAME as ProductName, 
  'Query Zone Processing - Overwrite DIMProduct' as Created_By,	
  '' as Modified_By,	
...
dbutils.fs.rm("dbfs:/user/hive/warehouse/cgs.db/DIMProduct", True)
...
execsp = "IF OBJECT_ID('stage.DIMProduct') IS NOT NULL DROP TABLE stage.DIMProduct"
execute_sqldw_stored_procedure_no_results(execsp)
