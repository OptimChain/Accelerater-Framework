...
def get_table_schema(containerName, dataPath, tableName, dataLakeZone="Query", notebookExecutionLogKey=0):
  ...
  try:
    ...
    if dataLakeZone == "Query":
      dbutils.notebook.run("./Query Zone Processing - InferSchema", 6000, {"parentPipeLineExecutionLogKey": notebookExecutionLogKey, "containerName": containerName, "dataPath": dataPath, "tableName": tableName, "samplingRatio": .5})
