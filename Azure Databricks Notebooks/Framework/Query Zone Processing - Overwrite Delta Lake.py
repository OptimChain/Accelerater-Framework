...
dbutils.widgets.text(name="rawDataPath", defaultValue="/Raw/MAPS/ClientService", label="Raw Data Path")
...
dbutils.widgets.text(name="tableName", defaultValue="ClientService", label="Table Name")
...
# sourceAsset = client.get_entity(qualifiedName=sourcePath,typeName="azure_datalake_gen2_path")
