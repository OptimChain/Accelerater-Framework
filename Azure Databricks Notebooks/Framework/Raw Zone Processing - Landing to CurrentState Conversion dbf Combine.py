...
#dbutils.widgets.text(name="tableName", defaultValue="GL", label="Table Name")
...
#destinationPath = "https://" + adlsgen2storageaccountname + ".dfs.core.windows.net/" + containerName + "/Query/CurrentState/CaseWare/" + tableName + "/{SparkPartitions}"  
...
#create_purview_lineage_ingest(sourcePath, destinationPath, notebookName,"",str(notebookExecutionLogKey))
...
# MAGIC %md
# MAGIC ###Script to Convert dbf to Delta
  ...
  def fileConversion(sourceFile,destinationFile):
    ...
    if fileExtension == 'dbf':
      ...
      if dest_df.empty == False:
        ...
        sourceFile = sourceFile.replace('/dbfs/mnt/rsm/Landing/CaseWare/Dbf/','')
