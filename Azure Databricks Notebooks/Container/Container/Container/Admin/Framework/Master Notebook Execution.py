...
if sanctionedZoneNotebookPath != '..':
  run_with_retry(sanctionedZoneNotebookPath, 600, {"parentPipeLineExecutionLogKey": pipeLineExecutionLogKey, "containerName": containerName, "schemaName": parameters['queryZoneSchemaName'], "tableName": parameters['queryZoneTableName'], "numPartitions": numPartitions})
