...
curl https://repo1.maven.org/maven2/com/microsoft/azure/azure-sqldb-spark/1.0.2/azure-sqldb-spark-1.0.2-jar-with-dependencies.jar > /etc/sqldb/azure-sqldb-spark.jar
apt-get update
ACCEPT_EULA=Y apt-get install msodbcsql17
apt-get -y install unixodbc-dev
sudo apt-get install python3-pip -y
pip3 install --upgrade pyodbc
pip3 install "https://repo1.maven.org/maven2/com/microsoft/azure/azure-sqldb-spark/1.0.2/azure-sqldb-spark-1.0.2-jar-with-dependencies.jar"
""", True)
...
# MAGIC maven activate /FileStore/jars/maven/