...
fullyQualifiedTableName = dbutils.widgets.get("containerName") + "." + tableName
...
sql = """OPTIMIZE {0}""".format(fullyQualifiedTableName)
spark.sql(sql)
...
if vacuum == 'True':
  ...
  spark.sql("VACUUM " + fullyQualifiedTableName + " RETAIN 72 HOURS")
