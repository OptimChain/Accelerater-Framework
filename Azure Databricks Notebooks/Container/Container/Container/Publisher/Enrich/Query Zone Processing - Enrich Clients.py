...
dbutils.widgets.text(name="tableName", defaultValue="Clients", label="Table Name")
...
SELECT 
  ...
  ,IsAudit
  ,cast(MasterId as Long) as MasterId
  ,string(hash('sha2_256',Name)) as Name
  ,string(hash('sha2_256',NameContact)) as NameContact
  ,dateLoaded
  ,'Query Zone Processing - Enrich Clients' AS Created_By
  ,'' AS Modified_By
