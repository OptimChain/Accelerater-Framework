...
# MAGIC  
# MAGIC %md
# MAGIC # Sanctioned Zone Processing - Load Synapse DW Overwrite
...
dbutils.widgets.text(name="schemaName", defaultValue="stage", label="Schema Name")
dbutils.widgets.text(name="tableName", defaultValue="Incremental_InventoryTransPosting", label="Table Name")
