...
# MAGIC  
# MAGIC %md
# MAGIC # Query Zone Processing - Overwrite InventoryBudgetMargin
...
dbutils.widgets.text(name="tableName", defaultValue="FCTInventoryBudgetMargin", label="Table Name")
...
stageTableName = "Margin"

databaseStageTableName = containerName + "." + stageTableName

currentStateStagePath = fullPathPrefix + "/Query/CurrentState/InventoryBudget/"  + stageTableName


# COMMAND ----------

notebookName = "Query Zone Processing - Overwrite InventoryBudgetMargin"
...
dbutils.fs.rm("dbfs:/user/hive/warehouse/cgs.db/FCTInventoryBudgetMargin", True)
...
execsp = "DELETE brtl.FCTInventoryBudgetMargin"
try:
