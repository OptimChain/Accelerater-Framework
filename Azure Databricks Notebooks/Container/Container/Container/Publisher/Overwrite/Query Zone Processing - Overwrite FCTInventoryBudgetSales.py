...
# MAGIC  
# MAGIC %md
# MAGIC # Query Zone Processing - Overwrite InventoryBudgetSales
...
dbutils.widgets.text(name="tableName", defaultValue="FCTInventoryBudgetSales", label="Table Name")
...
notebookName = "Query Zone Processing - Overwrite InventoryBudgetSales"
...
dbutils.fs.rm("dbfs:/user/hive/warehouse/cgs.db/FCTInventoryBudgetSales", True)
...
execsp = "DELETE brtl.FCTInventoryBudgetSales"
try:
