...
# MAGIC  
# MAGIC %md
# MAGIC # Query Zone Processing - Overwrite DIMStore
# MAGIC ###### Author: Chaitanya Badam 05/28/2020
# MAGIC 
...
dbutils.widgets.text(name="tableName", defaultValue="DIMStore", label="Table Name")
...
stageTableName = "RETAILCHANNELTABLE"
...
notebookName = "Query Zone Processing - Overwrite DIMStore"
...
SELECT STORENUMBER,
       ...
       RECID,
       ECL_NPLEXSTOREID,
       ECL_CARECLINICDEPTNUMBER,
       ECL_CARECLINICSTORENUMBER,
       ECL_BRTLPHARMACYPHONENUM
FROM {0}
""".format(databaseStageTableName)	
...
dbutils.fs.rm("dbfs:/user/hive/warehouse/cgs.db/DIMStore", True)
