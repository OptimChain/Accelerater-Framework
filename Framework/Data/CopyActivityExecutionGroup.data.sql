...
MERGE dbo.CopyActivityExecutionGroup AS t
  USING (
  VALUES 
		(1,'TSA Copy Process',1,0,getdate(),NULL),
		(2,'TSA_Rolling Copy Process',1,0,getdate(),NULL),
		(3,'CaseWare Copy Process',1,0,getdate(),NULL),
		(4,'MAPS Copy Process',1,0,getdate(),NULL)
		) as s
		(
