...
$ContainerName  = 'cilent02'

$StorageAccountName = 'dadevwus2analyticsdlbrbw'
$AccessKey = 'MYopkDS5qb4KVNR2Krf7GZLy/B2VIkKQn0AbiTEiQAr0fllMW+5AdhG6BayIMD6hShBtkRK2E6o7+ZErhUItuQ=='
